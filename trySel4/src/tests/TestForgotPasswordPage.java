...
public class TestForgotPasswordPage {
  ...
  public void testLoginPage(String email, String type) throws InterruptedException {
	  ...
	  if (type=="valid"){
	    ...
	    try{
	    	...
	    	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			  ...
			  Reporter.log("Error in retrieving password");
	    	...
	    	try{
		    	...
		    	Reporter.log("Password can't be retrieved");
		    	objForgotPasswordPage.clearEmail();
		    	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		    }
		    catch (AssertionError e){
